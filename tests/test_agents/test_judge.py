...
def conceptual_qa():
    return {
        ...
        "options": {"A": "Follow the approved schedule.", "B": "Ignore the schedule.", "C": "Ask a passenger.", "D": "Wait until a problem occurs."},
        "correct_answer": "A",
        "explanations": {"A": "This is the correct action.", "B": "Ignoring the schedule is unsafe.", "C": "Passengers are not responsible.", "D": "Waiting is not compliant."},
...
def practical_qa():
    return {
        ...
        "options": {"A": "Ignore the schedule.", "B": "Follow the approved maintenance schedule.", "C": "Ask a passenger.", "D": "Wait until a problem occurs."},
        "correct_answer": "B",
        "explanations": {"A": "Ignoring the schedule is unsafe.", "B": "This is the correct action.", "C": "Passengers are not responsible.", "D": "Waiting is not compliant."},
        "source_reference": "Article 2",
        "difficulty": "easy",
        "focus": "practical"
    }
...
def test_judge_accepts_both(conceptual_qa, practical_qa, validation_results, sample_chunk):
...
def test_judge_refines_one(conceptual_qa, practical_qa, validation_results, sample_chunk):
    mock_response = MagicMock()
    mock_response.content = [MagicMock(text='{"decision": "refine_conceptual", "reasoning": "Conceptual question needed clarity.", "improvements_made": ["Improved clarity"], "questions": [{"question": "What is required for aircraft maintenance? (refined)", "options": {"A": "Follow the approved schedule.", "B": "Ignore the schedule.", "C": "Ask a passenger.", "D": "Wait until a problem occurs."}, "correct_answer": "A", "explanations": {"A": "This is the correct action.", "B": "Ignoring the schedule is unsafe.", "C": "Passengers are not responsible.", "D": "Waiting is not compliant."}, "source_reference": "Article 2", "difficulty": "easy", "focus": "conceptual"}, {"question": "What should a pilot do if the aircraft is due for maintenance?", "options": {"A": "Ignore the schedule.", "B": "Follow the approved maintenance schedule.", "C": "Ask a passenger.", "D": "Wait until a problem occurs."}, "correct_answer": "B", "explanations": {"A": "Ignoring the schedule is unsafe.", "B": "This is the correct action.", "C": "Passengers are not responsible.", "D": "Waiting is not compliant."}, "source_reference": "Article 2", "difficulty": "easy", "focus": "practical"}]}' )]
    with patch('src.quiz_gen.agents.judge.Anthropic') as mock_anthropic:
        mock_client = MagicMock()
        mock_client.messages.create.return_value = mock_response
        mock_anthropic.return_value = mock_client
...
def test_judge_rejects_both(conceptual_qa, practical_qa, validation_results, sample_chunk):
    mock_response = MagicMock()
    mock_response.content = [MagicMock(text='{"decision": "reject_both", "reasoning": "Both questions failed validation.", "improvements_made": [], "questions": []}')]
    with patch('src.quiz_gen.agents.judge.Anthropic') as mock_anthropic:
        mock_client = MagicMock()
        mock_client.messages.create.return_value = mock_response
        mock_anthropic.return_value = mock_client
