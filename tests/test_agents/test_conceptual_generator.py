...
def test_generate_calls_openai_and_parses_response(sample_chunk):
    ...
    mock_response.choices = [
        MagicMock(message=MagicMock(content="""{"question": "What is an unmanned aircraft?", "options": {"A": "An aircraft operated without a pilot on board.", "B": "A manned aircraft.", "C": "A paper plane.", "D": "A kite."}, "correct_answer": "A", "explanations": {"A": "This matches the definition.", "B": "Manned aircraft have pilots.", "C": "Paper planes are toys, not aircraft.", "D": "Kites are not aircraft."}, "source_reference": "Article 1", "difficulty": "easy", "focus": "conceptual"}"""))
    ]
